...
import { ListEventDatesUseCase } from "../ListEventDatesUseCase";
...
describe("ListEventDatesUseCase", () => {
  let useCase: ListEventDatesUseCase;
  let eventRepository: InMemoryEventRepository;

  beforeEach(() => {
    eventRepository = new InMemoryEventRepository();
    useCase = new ListEventDatesUseCase(eventRepository);
  });

  it("should list event dates successfully", async () => {
